...
export default function FastSignDocsV2Loading() {
  return (
    <div className="min-h-screen flex items-center justify-center" style={{ backgroundColor: "#F8F9FB" }}>
      <div className="text-center">
        ...
        <h2 className="text-xl font-semibold text-gray-900 mb-2">Cargando Documentos V2</h2>
        <p className="text-gray-600">Preparando tu gestión de documentos Fast Sign mejorada...</p>
