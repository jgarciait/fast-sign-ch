...
const FastSignDocumentManager = lazy(() => import("@/components/fast-sign-document-manager"))
...
export default function FastSignDocsPage() {
    ...
    <div className="min-h-screen" style={{ backgroundColor: "#F8F9FB" }}>
      <div className="p-8">
        <Suspense fallback={<LoadingComponent />}>
          <FastSignDocumentManager onClose={handleClose} />
        </Suspense>
      </div>
    </div>
  )
